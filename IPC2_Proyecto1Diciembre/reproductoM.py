...
class ReproductoMusica: 
    ...
    def __init__(self): 
       ...
       # self.CA.resizable(0, 0)
        ...
        #Boton crear Reportes

        self.botonPlaylist = tk.Button(self.CA,text = "Reportes",background = "#56070c",foreground = "#ffffff",height = 2, width = 10,font=("Courier New", 10))
        self.botonPlaylist.bind("<Button>",lambda e: Reportes()) 
        self.botonPlaylist.grid(row=5, column=6, columnspan=1,rowspan=1 ,padx=2, pady=5)
        
    
        #**********************
        
        #Boton reproduccion lista de reproduccion

        self.botonrepro = tk.Button(self.CA,text = "Listas de reproduccion",background = "#56070c",foreground = "#ffffff",height = 2, width = 10,font=("Courier New", 10))
        self.botonrepro.bind("<Button>",lambda e: BotonListasR()) 
        self.botonrepro.grid(row=6, column=6, columnspan=1,rowspan=1 ,padx=2, pady=5)
    ...
    def AccionAdelante(self):
        ...
        l=blb.obtenerNodo(self.apuntador.dato.nombre)
        print(l.dato.nombre)
        print(l.dato.contador)
        l.dato.contador+=1
        print(l.dato.contador)
    ...
    def BuscarCancion(self):
        ...
        k=blb.obtenerNodo(str(self.buscarEntry.get()))
